...
### Recent Projects
* [Drop](https://getdrop.dev): Share secrets directly from your terminal | `Go` `NodeJS` `React`
* [ReelQuotes](https://reelquotes.app): Displays a random or curated movie quote as your homepage. | `Go` `NodeJS` `React` `TailwindCSS`
